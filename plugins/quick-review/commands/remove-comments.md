...
Almost always, a comment is a sign for a code smell. Please look at the info you have (in memory / claude.md) about comments, and start working with the user on how to remove them from [the relevant code you're working on].
